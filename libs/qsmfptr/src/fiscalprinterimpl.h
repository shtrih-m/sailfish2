#ifndef FISCALPRINTERIMPL_H
#define FISCALPRINTERIMPL_H
...
private:
    ...
    QString physicalDeviceDescription;
    QString deviceServiceDescription;
    int deviceServiceVersion;
    QString physicalDeviceName;
    int state;
    bool capAdditionalLines;
    bool capAmountAdjustment;
    bool capAmountNotPaid;
    bool capCheckTotal;
    bool capFixedOutput;
    bool capIndependentHeader;
    bool capItemList;
    bool capNonFiscalMode;
    bool capOrderAdjustmentFirst;
    bool capPercentAdjustment;
    bool capPositiveAdjustment;
    bool capPowerLossReport;
    bool capPredefinedPaymentLines;
    bool capReceiptNotPaid;
    bool capRemainingFiscalMemory;
    bool capReservedWord;
    bool capSetHeader;
    bool capSetPOSID;
    bool capSetStoreFiscalID;
    bool capSetTrailer;
    bool capSetVatTable;
    bool capSlpFiscalDocument;
    bool capSlpFullSlip;
    bool capSlpValidation;
    bool capSubAmountAdjustment;
    bool capSubPercentAdjustment;
    bool capSubtotal;
    bool capTrainingMode;
    bool capValidateJournal;
    bool capXReport;
    bool capAdditionalHeader;
    bool capAdditionalTrailer;
    bool capChangeDue;
    bool capEmptyReceiptIsVoidable;
    bool capFiscalReceiptStation;
    bool capFiscalSlipStation;
    bool capFiscalReceiptType;
    bool capMultiContractor;
    bool capOnlyVoidLastItem;
    bool capPackageAdjustment;
    bool capPostPreLine;
    bool capSetCurrency;
    bool capTotalizerType;
    bool capStatisticsReporting;
    bool capUpdateStatistics;
    bool capCompareFirmwareVersion;
    bool capUpdateFirmware;
    bool capPositiveSubtotalAdjustment;
    bool duplicateReceipt;
    int outputID;
    int powerNotify;
    int powerState;
    int countryCode;
    ...
    QString errorString;
    bool flagWhenIdle;
    QString predefinedPaymentLines;
    ...
    QString additionalTrailer;
    QString changeDue;
    int contractorId;
    int dateType;
    int fiscalReceiptStation;
    int fiscalReceiptType;
    int messageType;
    int totalizerType;
    int graphicsLine;
    bool isReceiptOpened;
    QString logicalName;
    bool asyncMode;
    bool connected;
    int receiptType;
